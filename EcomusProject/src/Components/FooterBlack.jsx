...
const FooterBlack = () => {
  return (
    <div>
        {/* FOOTER */}
    <div class="bg-white">
      <div class="max-w-screen-xl mx-auto px-4 sm:px-6  text-black flex flex-wrap justify-between">
        <div class="p-5">
          <div>
            {" "}
            <img src={logo} alt=""/>
        ...
        <div class="p-5">
          <div class="text-xs uppercase text-black font-medium">Help</div>
        ...
        <div class="p-5">
          <div class="text-xs uppercase text-black font-medium">
            About Us
          </div>
